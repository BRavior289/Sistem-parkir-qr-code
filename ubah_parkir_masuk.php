...
$data_parkir_masuk = query("SELECT * FROM data_parkir_masuk WHERE id_karcis = '$id_karcis'")[0];
...
function ubah($data)
{
    ...
    $tanggal_jam_masuk = htmlspecialchars($data['tanggal_jam_masuk']);

    $query = "UPDATE data_parkir_masuk SET tanggal_jam_masuk='$tanggal_jam_masuk', jenis_kendaraan='$jenis_kendaraan', no_plat='$no_plat' WHERE id_karcis='$id_karcis' ";
    ...
    if (ubah($_POST) > 0) {
        echo "
            <script>
                ...
                document.location.href = 'data_parkir_masuk.php';
            </script>
            ";
    } else {
        echo "
                ...
                <div class="row page-titles mx-0 shadow-lg">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="data_parkir_masuk.php">Parkir Masuk</a></li>
                    ...
                    <div class="col-xl-6 col-xxl-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Form Ubah Parkir Masuk</h4>
                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group col-4">
                                                        ...
                                                        <input type="text" name="" readonly value="<?php echo 'KC-' . $data_parkir_masuk["id_karcis"] ?>" class="form-control" placeholder="" readonly>
                                                        <input type="text" id="id_karcis" name="id_karcis" class="form-control" placeholder="" value="<?php echo $data_parkir_masuk["id_karcis"] ?>" hidden>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group col-md-5">
                                                        <label for="tanggal_jam_masuk">Tanggal Masuk</label>
                                                        <input type="datetime-local" id="tanggal_jam_masuk" class="form-control" name="tanggal_jam_masuk" placeholder="tanggal_jam_masuk" value="<?php echo $data_parkir_masuk["tanggal_jam_masuk"] ?>">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group col-4">
                                                        ...
                                                        <input type="text" id="no_plat" class="form-control" name="no_plat" placeholder="no_plat" value="<?php echo $data_parkir_masuk["no_plat"] ?>">
                                                    </div>
                                                </div>
                                            </div>
