...
$id_jenis_kendaraan = $_GET["id_jenis_kendaraan"];
// ambil 1 baris data dari tabel mahasiswa
$data_jenis_kendaraan = query("SELECT * FROM data_jenis_kendaraan WHERE id_jenis_kendaraan = $id_jenis_kendaraan")[0];
...
function ubah($data)
{
    ...
    $query = "UPDATE data_jenis_kendaraan SET jenis_kendaraan='$jenis_kendaraan', tarif='$tarif' WHERE id_jenis_kendaraan='$id_jenis_kendaraan' ";
...
if (isset($_POST["submit"])) {
    if (ubah($_POST) > 0) {
        ...
        echo "
                <script>
                    alert('Tidak ada data yg berubah!!');
                </script>
                ";
    }
}
                ...
                <div class="row page-titles mx-0 shadow-lg">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="data_jenis_kendaraan.php">Data Jenis Kendaraan</a></li>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group col-4">
                                                        <label for="id_jenis_kendaraan">ID Jenis Kendaraan</label>
                                                        <input type="text" name="" value="<?= $a = 'JK' . sprintf('%03s', $data_jenis_kendaraan["id_jenis_kendaraan"]); ?>" class="form-control" placeholder="" readonly>
                                                        <input type="text" id="id_jenis_kendaraan" name="id_jenis_kendaraan" class="form-control" placeholder="" value="<?php echo $data_jenis_kendaraan["id_jenis_kendaraan"] ?>" hidden>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group col-4">
                                                        <label for="jenis_kendaraan">Jenis Kendaraan</label>
                                                        <input type="text" id="jenis_kendaraan" class="form-control" name="jenis_kendaraan" placeholder="jenis_kendaraan" value="<?php echo $data_jenis_kendaraan["jenis_kendaraan"] ?>">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group col-4">
                                                        <label for="tarif">Tarif</label>
                                                        <input type="number" id="tarif" class="form-control" name="tarif" placeholder="tarif" value="<?php echo $data_jenis_kendaraan["tarif"] ?>">
                                                    </div>
                                                </div>
                                            </div>
